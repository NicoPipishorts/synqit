...
export const AuthPageLayout = ({ title, description, children }: AuthPageLayoutProps) => {
  return (
    <section className="relative mx-auto flex min-h-dvh w-full max-w-4xl items-center justify-center px-6 pb-[calc(env(safe-area-inset-bottom)+2rem)] pt-[calc(env(safe-area-inset-top)+2rem)] sm:px-6 sm:py-12 lg:px-8 lg:py-16">
