...
export const AuthPageLayout = ({ title, description, children }: AuthPageLayoutProps) => {
  return (
    <section className="relative mx-auto flex h-dvh w-full max-w-4xl items-center justify-center px-6 pb-[max(3rem,calc(env(safe-area-inset-bottom)+2rem))] pt-[max(3rem,calc(env(safe-area-inset-top)+2rem))] lg:px-8">
