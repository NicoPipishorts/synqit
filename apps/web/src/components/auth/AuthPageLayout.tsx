...
export const AuthPageLayout = ({ title, description, children }: AuthPageLayoutProps) => {
  return (
    <section className="relative mx-auto flex min-h-dvh w-full max-w-4xl items-end px-4 pb-[calc(env(safe-area-inset-bottom)+2rem)] pt-[calc(env(safe-area-inset-top)+2rem)] sm:min-h-[calc(100svh-8rem)] sm:px-6 sm:py-12 lg:px-8 lg:py-16">
