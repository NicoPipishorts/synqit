  ...
  return (
    <div className={rootClassName}>
      <a
        ...
        target="_blank"
        rel="noreferrer"
        className={`group inline-flex min-w-0 items-center justify-between gap-3 rounded-xl border border-app-border bg-app-surface px-3 py-1 text-app-text shadow-soft-lift transition duration-150 hover:border-brand-pink focus-ring-brand dark:bg-app-elevated ${
          shareMode === 'inline' ? 'flex-1' : 'flex-1'
        }`.trim()}
      >
