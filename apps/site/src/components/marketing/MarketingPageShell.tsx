...
export const MarketingPageShell = ({ children, contentClassName }: MarketingPageShellProps) => (
  <div className="relative bg-brand-dark dark:bg-brand-white">
    ...
    <div className="relative z-10 overflow-clip rounded-b-[2.75rem] bg-app-bg shadow-[0_28px_64px_-20px_rgba(0,0,0,0.55)] dark:shadow-[0_30px_70px_-20px_rgba(0,0,0,0.72)] sm:rounded-b-[3.5rem] lg:rounded-b-[4.5rem]">
