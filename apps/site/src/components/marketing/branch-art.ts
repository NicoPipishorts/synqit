 ...
 *
 * Four full wobbles of 48 each from y=8, then a straight run into the tip. Every
...
export const HERO_CUE_BRANCH_D =
  'M24 8 C12 24, 36 40, 24 56 C12 72, 36 88, 24 104 C12 120, 36 136, 24 152 C12 168, 24 188, 24 200 L24 224';

export const HERO_CUE_TIP = { x: 24, y: 224 } as const;
 ...
 * end.
 */
export const HERO_CUE_VIEWBOX = { width: 48, height: 240 } as const;
