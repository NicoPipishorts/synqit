...
export const renderRegistrationInviteTemplate = (params: {
  locale: EmailLocale;
  webAppUrl: string;
  recipientEmail: string;
  inviteUrl: string;
  ...
  if (params.locale === 'fr') {
    return {
      subject: 'Votre invitation Synqit',
      html: renderHtml({
        title: 'Vous êtes invité sur Synqit',
        intro: `Une invitation a &eacute;t&eacute; pr&eacute;par&eacute;e pour <strong>${safeEmail}</strong>.`,
        body: "Créez votre compte avec le lien ci-dessous. Votre token d'inscription sera pr&eacute;rempli automatiquement.",
        cta: 'Créer mon compte',
        outro: "Si vous n'attendiez pas cette invitation, vous pouvez ignorer cet e-mail.",
      }),
      text:
        `Vous êtes invité sur Synqit.\n\n` +
        `Une invitation a été préparée pour ${params.recipientEmail}.\n` +
        `Créer mon compte: ${params.inviteUrl}\n\n` +
        `Si vous n'attendiez pas cette invitation, vous pouvez ignorer cet e-mail.`,
    };
  }

  return {
    subject: 'Your Synqit invite',
    html: renderHtml({
      title: 'You are invited to Synqit',
      intro: `An invitation has been prepared for <strong>${safeEmail}</strong>.`,
      body: 'Create your account with the link below. Your registration token will be filled in automatically.',
      cta: 'Create my account',
      outro: 'If you were not expecting this invite, you can safely ignore this email.',
    }),
    text:
      `You are invited to Synqit.\n\n` +
      `An invitation has been prepared for ${params.recipientEmail}.\n` +
      `Create my account: ${params.inviteUrl}\n\n` +
