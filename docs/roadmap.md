...
| Qobuz                       | Partner API (REST v0.2, `app_id`/`app_secret` issued by email from api@qobuz.com, tied to a Qobuz login). No OAuth documented: `user/login` takes email + password and returns a token. Partnerships via society@qobuz.com              | Reachable: Soundiiz is listed in the Qobuz Help Center for import, export and sync. Plan, emails, brief, technical sheet and compliance checklist in `docs/partners/qobuz/`. Blocker is a reply from Qobuz, plus the password-based connect flow to design around.                                                                                                                                                                                                                                                                                                                                                                                                  |
