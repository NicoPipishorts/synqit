  ...
  return (
    ...
    >
      ...
      <span
        role="tooltip"
        className={cn(
          'pointer-events-none absolute -left-2 z-40 w-max max-w-[min(16rem,calc(100vw-2.5rem))] rounded-xl border-2 border-app-text bg-app-elevated px-3 py-2 text-left text-xs font-semibold normal-case leading-snug tracking-normal text-app-text shadow-sticker-sm transition duration-150 dark:bg-app-card',
      ...
      >
        ...
        <span
          aria-hidden="true"
          className={cn(
            'absolute left-3.5 h-3 w-3 rotate-45 border-2 border-app-text bg-app-elevated dark:bg-app-card',
            side === 'top'
